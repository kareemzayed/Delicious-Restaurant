...
<head>
    ...
    <title>Team | Delicouse Resturant</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Team
                        </h4>
                        <div class="card">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        @foreach ($team as $mem)
                                            <tr>
                                                ...
                                                <td> {{ $mem->linkedin }}</td>
                                                <td><span
                                                        class="badge bg-label-primary me-1">{{ $mem->photo }}</span>
                                                </td>
                                                <td>
                                                    <div class="dropdown">
                                                        <button type="button"
