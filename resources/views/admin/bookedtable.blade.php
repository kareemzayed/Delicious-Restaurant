...
<head>
    ...
    <title>Booked Tables | Delicouse Resturant</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Booked Tables
                        </h4>
                        <div class="card">
                            <h5 class="card-header">Team</h5>
                            @if (Route::has('add-new-member'))
                                <a type="button" class="btn btn-success" href="{{ route('add-new-member') }}"
                                    style="width: 190px; margin-left: 80%; color: white; font-size: 13px">
                                    Add New Table
                                </a>
                            @endif
                            <br>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        @foreach ($tables as $table)
                                            <tr>
                                                ...
                                                <td> {{ $table->people }}</td>
                                                <td><span
                                                        class="badge bg-label-primary me-1">{{ Crypt::decryptString($table->card) }}</span>
                                                </td>
                                                <td> {{ $table->photo }}</td>
                                                <td>
                                                    <div class="dropdown">
