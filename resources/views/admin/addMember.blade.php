...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ asset('assetsDashboard') }}/" data-template="vertical-menu-template-free">

<head>
    <meta charset="utf-8" />
    <meta name="viewport"
        content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />
    <title>Add New Member | Delicouse Resturant</title>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">Delicouse</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('getBookedTables') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-home-circle"></i>
                            <div data-i18n="Analytics">Booked Tables</div>
                        </a>
                    </li>
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a
                                    href="{{ route('dashboard') }}">Dashboard</a>/</span> Add New Member
                        </h4>
                        <div class="row">
                            <div class="col-xl">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if (Session::has('addedMember'))
                                            <div class="alert alert-success" role="alert">
                                                {{ Session::get('addedMember') }}
                                            </div>
                                        @endif
                                        ...
                                        <form method="POST" action="{{ route('addMember') }}"
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="basic-default-company">Collage
                                                    ID</label>
                                                <input type="text"
                                                    class="form-control @error('col_id') is-invalid @enderror"
                                                    name="col_id" id="basic-default-company"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input type="text" id="basic-default-email"
                                                        class="form-control @error('col_email') is-invalid @enderror"
                                                        name="col_email" placeholder="@example.cis.asu.edu.eg"
                                                        aria-label="john.doe"
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="basic-default-phone">Facebook
                                                    URL</label>
                                                <input type="text" id="basic-default-phone"
                                                    class="form-control @error('facebook') is-invalid @enderror"
                                                    name="facebook" placeholder="https://themeselection.com" />
                                                @error('facebook')
                                                    <span class="invalid-feedback" role="alert">
                                                        <small>{{ $message }}</small>
                                                    </span>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="basic-default-phone">Instegram
                                                    URL</label>
                                                <input type="text" id="basic-default-phone"
                                                    class="form-control @error('instegram') is-invalid @enderror"
                                                    name="instegram" placeholder="https://themeselection.com" />
                                                @error('instegram')
                                                    <span class="invalid-feedback" role="alert">
                                                        <small>{{ $message }}</small>
                                                    </span>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="basic-default-phone">Linked In
                                                    URL</label>
                                                <input type="text" id="basic-default-phone"
                                                    class="form-control @error('linkedin') is-invalid @enderror"
                                                    name="linkedin" placeholder="https://themeselection.com" />
                                                @error('linkedin')
                                                    <span class="invalid-feedback" role="alert">
                                                        <small>{{ $message }}</small>
                                                    </span>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="basic-default-phone">Member
                                                    Photo</label>
