...
<head>
    ...
    <title>Two Factor Authentication | Delicious Resturant</title>
                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Two Factor Authentication</span>
                            </a>
                        </div>
                        <h4 class="mb-2">Confirm Your Account</h4>
                        <p class="mb-4">Please Enter Your Authentication Code To Login</p>
                        
                        <form id="formAuthentication" class="mb-3" action="{{ route('two-factor.login') }}"
                            method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="code" class="form-control @error('code') is-invalid @enderror"
                                    id="code" name="code" placeholder="Enter your code" required autofocus />
                                @error('code')
