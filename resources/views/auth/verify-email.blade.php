...
<head>
    ...
    <title>Email Verification | Delicious Resturant</title>
                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Verify Your Email Address</span>
                            </a>
                        </div>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('verification.send') }}"
                            method="POST">
                            @csrf
                            <button type="submit" class="btn btn-primary d-grid w-100">Click here to request
                                another</button>
                        </form>
