...
<head>
    ...
    <title>Reset Password | Delicious Resturant</title>
                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Reset Your Password</span>
                            </a>
                        </div>
                        <h4 class="mb-2">Reset Password And Keep It Safe</h4>
                        <p class="mb-4">Please Enter Your Email And Your New Password</p>
